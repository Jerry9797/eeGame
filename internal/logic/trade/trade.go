...
import (
	"context"
	"crypto/ecdsa"
	"eeGame/internal/logic/trade/contract_metadata"
...
type Trade struct {
	...
	gameManger            *contract_metadata.GameManagement
	chainId               *big.Int
...
func NewTrade(ctx context.Context) (*Trade, error) {
	...
	gameManger, err := contract_metadata.NewGameManagement(eeStableCoinAddress, client)
	if err != nil {
		return nil, err
	}
	return &Trade{
...
func (t *Trade) StartGame(ctx context.Context, roomId *big.Int, userAddress []common.Address, minQualifiedAmount *big.Int) error {
	...
	err = t.gatGasLimit(auth, t.gameManagementAddress, contract_metadata.GameManagementMetaData.ABI, "startGame", roomId, userAddress, minQualifiedAmount)
	if err != nil {
		return err
	}
...
func (t *Trade) EndGame(ctx context.Context, roomId *big.Int, winner common.Address, userAddress []common.Address, betAmounts []*big.Int) error {
	...
	err = t.gatGasLimit(auth, t.gameManagementAddress, contract_metadata.GameManagementMetaData.ABI, "endGame", roomId, winner, userAddress, betAmounts)
	if err != nil {
		return err
	}
